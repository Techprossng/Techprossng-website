...
function BenefitBootcamp() {
  return (
    <div className="bg-[#001975] w-full">
      <div className="text-[#fff]  items-center px-20 py-20 gap-9 benefits-container">
        <div className="benefit-title text-center  gap-2">
          <h5 className="text-5xl text-center font-secondary font-normal">
            Bootcamp Benefits
          </h5>
        </div>
        <div className="benefit-paragraph">
          <p className="text-sm text-center font-secondary mt-10 font-normal">
        ...
        <div className="benefit-card-holder flex flex-col gap-5 px-16 py-10  ">
          <div className="benefit-card-tray flex gap-5">
            <div className="benefit-card text-[#000] flex flex-col gap-3">
              <div>
                <h5 className=" font-primary text-[22px] font-bold">
              ...
              <div className="image-text-holder flex justify-between">
                ...
                <img src={Books} alt="picture of books" className="benefit-photos benefit-photo-books w-[45%] flex justify-center items-center"/>
              </div>
            </div>
            <div className="benefit-card-2 text-[#000] flex flex-col gap-3">
              <div>
                <h5 className=" text-[22px] font-primary font-bold">
          ...
          <div className="benefit-card-tray flex gap-5">
            <div className="benefit-card-2 text-[#000] flex flex-col gap-3">
              ...
              <div className="image-text-holder flex justify-between">
                ...
                <img src={Graduation} alt="picture of books" className="benefit-photos benefit-photos-cert w-[45%]"/>
              </div>
            </div>
            <div className="benefit-card text-[#000] flex flex-col gap-3">
              <div>
