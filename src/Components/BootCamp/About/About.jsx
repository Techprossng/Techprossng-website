        ...
        <div className="w-[50%]">
          <div className=" about-right-content">
            <p className="about-span font-medium ">
              TechProsNaija is gearing up for an extraordinary upcoming
              bootcamp, promising an immersive learning experience with a
              diverse array of over 10 cutting-edge courses. This educational
              extravaganza is set to be a game-changer, providing participants
              with in-depth insights and hands-on skills in various tech
              domains.
            </p>
            <div className="">
