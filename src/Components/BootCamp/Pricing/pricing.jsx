...
function Pricing() {
  ...
  <img src={Banner} className='w-[300px] relative ' style={{ top: "-67.6px"}}alt='Banner Image' />
  <p className='absolute text-[36px] top-[12px]  font-bold left-[39px] ' style={{ color: 'white' }}>
    ₦20,000.00
  </p>
        ...
        <h1 className='text-[140px] flex uppercase font-bold  font-secondary ' style={{ color: 'white' }}>
          Register
        </h1>
        <br/>
        <div className='flex justify-between'>
        <h1 className='text-[140px] uppercase flex ml-40 font-bold font-secondary' style={{ color: 'white' }}>
          now
        </h1>
