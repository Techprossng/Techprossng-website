        ...
        <div className="pricing-content">
          <div className="pricing-header">
            ...
            <p className="text-center text-[18px] mt-2 font-medium">
              ...
              <br className="line-break-6" /> where the affordable pricing
              ensures access to top-tier education, expert mentorship, and
              <br className="line-break-7" /> transformative learning
          ...
          <div className="flex justify-center">
            <button
              className="venue-register w-[590px] h-[82px] px-5 py-3 mt-16 "
              style={{ color: "#fff" }}
            >
