...
const Services = () => {
  return (
    ...
    <section className="services flex flex-col items-center justify-center">
      <div>
        <h4 className="text-3xl ml-24 mr-24" style={{ color: "#272727" }}>
          OUR SERVICES
        </h4>
        <div
      ...
      <div className="services-container flex justify-center items-center my-30 gap-20">
        <div className="card flex flex-col justify-center items-center text-center" data-aos="fade-right">
          <img src={online} alt="online-learning" />
          <h5 className="title text-3xl font-semibold mb-5">
            Online Learning and Training
          </h5>
          <p className="paragraph text-2xl font-medium">
