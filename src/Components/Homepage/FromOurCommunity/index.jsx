export default function FromOurCommunity() {
  return (
    <section className="p-[48px_64px] bg-[#CCD1E3]">
      ...
      <section className="max-[768px]:flex max-[768px]:overflow-hidden max-[768px]:overflow-x-scroll no-scrollbar max-[768px]:w-[150%]" >
        <div className="grid grid-cols-2 place-items-center gap-[32px] max-[768px]:flex max-[768px]:flex-nowrap max-[768px]:flex-shrink-0">
          <div className="bg-[#2B3F8C] rounded-[16px] min-h-[180px] md:max-w-[559px] max-w-[283px] flex max-[480px]:flex-col items-start gap-[16px]">
            <img src="src/assets/images/homepage_foc.png" className="md:w-[150px] max-h-[198px] w-full md:p-[16px] rounded-t-[16px] md:rounded-[0px] p-0 object-cover" />
            <div className="font-secondary text-white space-y-[16px] w-full p-[16px] pt-0">
