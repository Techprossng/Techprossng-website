    ...
    <>
      <div className="about-us">
        <div className="about-us-intro flex justify-around items-center">
          <div>
            <h2 className="font-black text-5xl leading-[67.5px] text-[#001562] font-primary">
              ABOUT US
            </h2>
          </div>
          <div>
            <h6 className="font-medium text-lg leading-[25.5px] text-[#272727] mt-5 font-primary">
              How we started...
            </h6>
            <p className="font-normal text-base leading-[24px] text-[#272727] mt-3 font-secondary">
          ...
          <div className="founder-inner">
            ...
            <div className="founder-frame flex gap-3 items-center">
              ...
              <div className="ceo-name">
                <h6 className="font-normal text-lg font-primary">Sogelola Mayomiwa</h6>
                <h6 className="font-medium text-xs font-secondary">Founder and CEO</h6>
              </div>
            </div>
          </div>
        </div>
        <div className="why-us flex gap-1 w-[100%] mb-10">
          <div className="impact-video ml-20 w-[50%]">
            <div className="thetext mt-8">
              <h4 className="font-bold text-3xl text-[#001562] font-primary">
                Why Choose Us?
              </h4>
              <p className="font-normal py-5 text-base font-secondary">
          ...
          >
            <div className="meritlist flex items-center gap-10 mx-10 mt-5 text-justify">
              <div className="meritimage">
                <img src={Merit} alt="icon" />
              </div>
              <div>
                <h5 className="merittext font-normal text-2xl text-[#fff] font-primary">Training</h5>
                <p className="merittext2 font-medium text-base text-[#fff] font-secondary">
            ...
            <div className="meritlist flex items-center gap-10 mx-10 text-justify">
              ...
              <div>
                <h5 className="merittext font-normal text-2xl text-[#fff] font-primary">
                  Flexibility
                </h5>
                <p className="merittext2 font-medium text-base text-[#fff] font-secondary">
        ...
        <div className="about-blog-section flex flex-col items-center">
            ...
            {Blogs.map((blog, index) => (
              ...
              >
                ...
                <div className="blog-text flex flex-col justify-start">
                  <p className="font-bold text-sm text-[#001562] font-secondary">
                    {blog.title}
                  </p>
                  <h5 className="font-bold text-2xl mt-3 font-primary">
                    {blog.description}
                  </h5>
                </div>
                <div className="blog-author flex justify-between font-secondary">
          ...
          <div className="blog-link w-full font-secondary mt-10 border-3 flex gap-10 justify-center items-center font-bold text-sm">
