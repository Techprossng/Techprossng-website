      ...
      <div className="resource"> 
        <div className="resource-hero flex gap-20">
          <div className="resource-hero-text w-[45%]">
            <div>
              ...
              <p className="font-medium text-base mt-7">
        ...
        <div className="resource-faq mt-20">
          <div>
            ...
            <p className="font-medium text-base text-[#555555] mt-5 w-[629px]">
              Browse our FAQs to find quick answers to common questions related to:
            </p>
          </div>
          <div className="faq-sub mt-10 flex justify-between">
            <div className="sub-items">
              <h6 className="font-bold text-xl">
                Courses
              </h6>
              <p className="font-medium text-base text-[#555555] mt-5">
          ...
          <div className="faq-sub mt-10 flex gap-20">
            <div className="sub-items">
              <h6 className="font-bold text-xl">
                Payment
              </h6>
            ...
            <div className="sub-items">
              <h6 className="font-bold text-xl ml-20">
                Account Management
              </h6>
              <p className="font-medium text-base text-[#555555] mt-5 ml-20">
        ...
        <div className="resource-contact mt-20">
          ...
          <div className="contact-sub mt-10 flex justify-between">
            <div className="sub-items">
              <h6 className="font-bold text-xl">
                Email Support
              </h6>
        ...
        <div className="guide-faq mt-20">
          ...
          <div className="guide-sub mt-10 flex justify-between">
            <div className="sub-items">
              <h6 className="font-bold text-xl">
          ...
          <div className="guide-sub mt-10 flex gap-10">
            <div className="sub-items">
              <h6 className="font-bold text-xl">
                Tips for Success
              </h6>
        ...
        <div className="flex justify-between mt-20">
          <div>
            ...
            <p className="font-medium text-base text-[#555555] mt-5 w-[526.5px]">
              Explore our library of user guides and resources to make the most of your learning journey:
            </p>
          </div>
          <div>
        ...
        <div>
          <h5 className="font-semibold text-2xl w-[1152px] my-20">
